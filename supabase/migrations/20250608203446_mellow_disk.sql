/*
  # Add sample data for skills and career paths

  1. Sample Data
    - Insert sample skills with various categories and premium rates
    - Insert sample career paths showing advancement opportunities
  
  Note: Tables and policies already exist from previous migration
*/
...
SELECT * FROM (VALUES
  ...
  ('General Nurse to Mental Health Specialist', 'Registered General Nurse', 'Mental Health Specialist Nurse', '+£5,000 - £8,000 annually', ARRAY['Mental Health First Aid', 'CBT Foundation', 'Risk Assessment'], '6-12 months', 'Specialize in mental health nursing with advanced training and significantly higher earning potential.'),
